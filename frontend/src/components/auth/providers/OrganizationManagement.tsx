  ...
  if (mode === 'manage' && selectedOrg) {
    return (
      <div className={`space-y-6 ${className}`}>
        ...
        {selectedOrg.role === 'admin' && (
          <div>
            ...
            <form onSubmit={handleInviteUser} className="space-y-3">
              <div className="flex gap-2">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    onChange={(e) => setField('inviteEmail', e.target.value)}
                    disabled={isLoading}
                    className="w-full pl-10 pr-3 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring text-sm bg-background text-foreground"
                  />
                </div>
                <select
                  ...
                  onChange={(e) => setField('inviteRole', e.target.value as 'admin' | 'member')}
                  disabled={isLoading}
              ...
              <button
                type="submit"
                disabled={!formData.inviteEmail || isLoading}
            ...
            <div className="space-y-2">
              {invitations.map((invitation) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={!isLoading ? () => handleCopyInviteLink(invitation.id) : undefined}
        ...
        {/* OAuth App Registration Section */}
        <div className="border-t border-border pt-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={!formData.appName || !formData.redirectURL}
