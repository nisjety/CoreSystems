...
export function SidebarSectionPage({
  ...
  return (
    <div className="min-h-dvh bg-[#F7F7FA] text-[#23252F]">
      <div className="border-b border-[#E5E7EE] bg-white px-6 py-8 md:px-10">
      ...
      <div className="px-6 py-10 md:px-10">
        <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <section className="rounded-[28px] border border-[#E6E8EF] bg-white p-6 shadow-[0_12px_30px_rgba(33,38,52,0.05)]">
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="rounded-full border border-[#E6E8EF] bg-[#F7F8FB] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#8A8E98]">
            ...
            <div className="mt-8 rounded-[22px] border border-dashed border-[#D8DCE5] bg-[#FAFBFD] p-5">
          ...
          <aside className="rounded-[28px] border border-[#E6E8EF] bg-white p-6 shadow-[0_12px_30px_rgba(33,38,52,0.05)]">
            <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-[#A2A6B1]">
              Available views
            </div>
                ...
                return (
                  <Link
                    ...
                    className={`block rounded-[18px] border px-4 py-3 transition-colors ${
                      isCurrent
                        ? 'border-[#E6E8EF] bg-[#F4F5F8]'
                        : 'border-transparent bg-[#FAFBFD] hover:border-[#E6E8EF] hover:bg-[#F7F8FB]'
                    }`}
                  >
