...
export function DashboardCards({ cards, stats = {}, onChatClick }: DashboardCardsProps) {
  ...
  React.useEffect(() => {
    ...
    const firstPage = pageRefs.current[0];
    const observer = typeof ResizeObserver !== 'undefined' && firstPage
      ? new ResizeObserver(measure)
      : null;

    if (observer && firstPage) {
