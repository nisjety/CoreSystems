...
export function OrgManagement() {
  ...
  const [selectedOrg, setSelectedOrg] = useState<OrgWithDetails | null>(null)
  ...
  const handleChangePlan = async (orgId: string, plan: 'free' | 'pro' | 'enterprise') => {
    try {
                ...
                <div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    <select
                      value={org.plan}
                      onChange={(e) =>
                        handleChangePlan(org.id, e.target.value as any)
                      }
