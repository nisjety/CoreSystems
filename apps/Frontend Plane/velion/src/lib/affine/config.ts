 ...
 *   NEXT_PUBLIC_AFFINE_SERVER_URL   – e.g. http://localhost:3180
 *   NEXT_PUBLIC_AFFINE_WS_URL       – e.g. ws://localhost:3180
 */

export const AFFINE_SERVER_URL =
  process.env.NEXT_PUBLIC_AFFINE_SERVER_URL ?? 'http://localhost:3180';
