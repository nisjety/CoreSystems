...
export function ProfileStep() {
  ...
  return (
    <form onSubmit={handleSubmit} data-testid="onboarding-profile-form" className="space-y-5">
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="firstName" className={labelClass}>Fornavn *</label>
          <input
            id="firstName"
            data-testid="onboarding-profile-firstName"
        ...
        <div>
          ...
          <input
            id="lastName"
            data-testid="onboarding-profile-lastName"
      ...
      <div>
        ...
        <input
          id="displayName"
          data-testid="onboarding-profile-displayName"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            id="jobTitle"
            data-testid="onboarding-profile-jobTitle"
        ...
        <div>
          ...
          <input
            id="department"
            data-testid="onboarding-profile-department"
      ...
      <div>
        ...
        <input
          id="phoneNumber"
          data-testid="onboarding-profile-phoneNumber"
          type="tel"
      ...
      <div>
        ...
        <input
          id="timezone"
          data-testid="onboarding-profile-timezone"
