	...
	return (
		<div className="mt-5 flex items-center gap-1 text-[#7d828a]">
			<button
				...
				aria-label={
					copyState === "copied" ? "Copied answer" : "Copy answer"
				}
				title={
					copyState === "failed"
						? "Could not copy"
...
export function ChatView({
	...
	// Regeneration is offered only on the latest assistant turn (matches the
	// AssistantActions tooltip); disabled while a response is still streaming.
