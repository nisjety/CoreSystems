...
This directory holds the architectural decisions that affect verevon's
...
| 0002 | [CP session-core repurpose](./0002-cp-session-core-repurpose.md) | accepted | verevon-gap.md G10 |
| 0003 | [L5 boundary policy](./0003-l5-boundary-policy.md) | accepted | verevon-gap.md G17 |
...
- Reference it in `verevon-gap.md` if the decision closes or downgrades a
  gap.
