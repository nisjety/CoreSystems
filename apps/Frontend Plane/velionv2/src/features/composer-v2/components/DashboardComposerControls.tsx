    ...
    <div className="mb-3 flex items-center justify-between px-1">
      <div className="flex items-center gap-2">
        <div className="relative">
          ...
          {modelOpen ? (
            <div className="verevon-popover absolute bottom-full left-0 z-[90] mb-2 w-64 rounded-2xl border border-black/[0.06] bg-white/95 p-1 text-sm shadow-[0_12px_40px_rgba(0,0,0,0.12)] backdrop-blur-xl dark:border-[#2A2C31] dark:bg-[#141516]/95">
        ...
        <Link
          ...
          title="Opprett agent"
          className="verevon-composer-control flex h-10 items-center gap-2 rounded-[12px] bg-[#2a2a2a] px-3 text-[13px] font-medium text-white shadow-md transition-all hover:bg-[#1a1a1a] active:scale-[0.97] sm:px-4"
        >
