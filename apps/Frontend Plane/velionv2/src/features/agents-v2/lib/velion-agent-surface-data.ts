...
export const salesInsightMetrics = [
  ...
  { label: "Top objection", value: "No live data", detail: "Objection clusters appear after handoffs are connected" },
...
export const ecommerceInsightCards = [
  ...
  { title: "Cart recovery", value: "No live data", detail: "Recovery rate appears after cart events connect" },
