  ...
  return (
    <article class="flex min-h-[260px] flex-col rounded-[12px] border border-[#E4E5E8] bg-white p-8 shadow-[0_1px_2px_rgba(16,24,40,0.04)] dark:border-[#303238] dark:bg-[#15161A]">
      <div class="flex items-start justify-between gap-4">
        ...
        <ToggleSwitch enabled={props.enabled} label={`${props.title} enabled`} />
      </div>
        ...
        {widget()
          ? (
            <div class="absolute bottom-0 left-1/2 h-[250px] w-[330px] -translate-x-1/2 rounded-t-[18px] border border-[#E1E2E6] bg-white shadow-[0_14px_34px_rgba(31,35,42,0.12)]">
              ...
              <div class="ml-5 mt-3 w-max rounded-full bg-[#F4F4F5] px-4 py-2 text-[12px]">Hi! What can I help you with?</div>
            </div>
          )
          : (
            <div class="absolute left-1/2 top-12 h-[246px] w-[620px] -translate-x-1/2 rounded-t-[18px] bg-white px-10 pt-16 shadow-[0_14px_34px_rgba(31,35,42,0.12)]">
              ...
              <h3 class="text-center text-[24px] font-semibold">How can we help you today?</h3>
              <div class="mt-8 flex h-20 items-center rounded-[16px] border border-[#E1E2E6] px-7 text-[17px] text-[#B1B3B9]">Ask a question…</div>
            </div>
          )}
      </div>
      <div class="p-7">
        <div class="flex items-start justify-between gap-4">
          <div>
            <h2 class="text-[21px] font-semibold">{widget() ? 'Chat widget' : 'Help page'}</h2>
