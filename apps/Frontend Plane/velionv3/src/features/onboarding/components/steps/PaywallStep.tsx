 ...
 * plan step can address the customer by name and show what Velion learned. */
...
export function PaywallStep(props: PaywallStepProps) {
  ...
  const suggestionKicker = () => {
    ...
    return props.recommendation?.source === 'model'
      ? i18n.tr('Velion AI-forslag', 'Velion AI suggestion')
      : i18n.tr('Velion forslag', 'Velion suggestion')
  }

  // Personalization: name + logo + what Velion learned from the crawl. Derived
    ...
    <section class="onboarding-paywall">
      ...
      <div class="onboarding-paywall__header">
        ...
        <div class="onboarding-paywall__billing">
          ...
          <VelionSwitch label={i18n.tr('Faktureringsperiode', 'Billing period')} />
              ...
              <div class="onboarding-paywall-card__head">
                ...
                <span class="onboarding-paywall-card__badges">
                  ...
                  <Show when={hasRecommendation() && recommendedPlanId() === plan.id}>
                    <span class="onboarding-paywall-card__badge">{i18n.tr('Velion foreslår', 'Velion suggests')}</span>
                  </Show>
  ...
  switch (planId) {
    case 'trial':
      return {
        ...
        description: i18n.tr(
          'Prøv Velion og agenten i 14 dager før du velger betalt plan.',
          'Try Velion and the agent for 14 days before choosing a paid plan.',
        ),
        features: [
