...
function KnowledgeSourcesList(props: {
  ...
  return (
    <section>
      <div class="core-sidebar-dedicated-group-header">
        <h2 class="velion-sidebar-group-title">{props.title}</h2>
              ...
              {(source) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span>
                      <span class="velion-sidebar-row-normal">{source.title}</span>
  ...
  return (
    <div>
      ...
      >
        ...
        <span class={props.depth === 0 ? 'velion-sidebar-row-strong' : 'velion-sidebar-row-normal'}>{props.folder.label}</span>
