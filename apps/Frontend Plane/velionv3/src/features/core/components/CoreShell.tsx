    ...
    <AgentsProvider>
      <div
        ...
        style={{
          ...
          '--velion-sidebar-accent': workspace().accentColor || undefined,
        }}
      >
        <CoreNavbar
        ...
        <main class="core-main">
          <div class="velion-workspace-panel dashboard-main-panel core-main__panel">
...
// Matches "AQUATIQ", "VELION", "MICROSOFT" but not "Ima", "John Smith", "João".
