        ...
        >
          <div class="dashboard-xsearch-velion__list">
            <For each={props.results}>
              {(result) => (
                <A href={result.href || '/knowledge'} class="dashboard-xsearch-velion__item">
                  <span class="dashboard-xsearch-velion__badge" aria-hidden="true">V</span>
                  <span class="dashboard-xsearch-velion__body">
                    <span class="dashboard-xsearch-velion__title">{result.label}</span>
                    <Show when={result.excerpt}>
                      <span class="dashboard-xsearch-velion__excerpt">{result.excerpt}</span>
                    </Show>
                  </span>
                  <Show when={result.source}>
                    <span class="dashboard-xsearch-velion__source">{result.source}</span>
                  </Show>
                </A>
              )}
            </For>
