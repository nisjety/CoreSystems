    ...
    <>
              ...
              {(schedule) => (
                <div class="velion-settings-integration-row">
                  <div>
                    <p>
                      {schedule.name}{' '}
                      <span class="velion-trust-chip" aria-label={`Status: ${schedule.enabled ? 'aktiv' : 'pauset'}`}>
      ...
      >
        <form class="velion-settings-field-grid velion-settings-field-grid--spaced" onSubmit={handleCreate}>
          <label for="cron-name" class="velion-settings-field">
          ...
          <label for="cron-expr" class="velion-settings-field">
            <span class="velion-settings-label">Cron-uttrykk</span>
            <span class="velion-settings-input-wrap">
              <VelionInput
                id="cron-expr"
                value={expr()}
          ...
          <label for="cron-tz" class="velion-settings-field">
            <span class="velion-settings-label">Tidssone</span>
            <span class="velion-settings-input-wrap">
              <VelionInput
                id="cron-tz"
                value={timezone()}
          ...
          <label for="cron-title" class="velion-settings-field">
            <span class="velion-settings-label">Oppgavetittel (valgfritt)</span>
            <span class="velion-settings-input-wrap">
              <VelionInput
                id="cron-title"
                value={title()}
