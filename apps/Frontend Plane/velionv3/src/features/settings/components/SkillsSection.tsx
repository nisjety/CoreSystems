    ...
    <>
              ...
              {(skill) => (
                <div class="velion-settings-integration-row">
                  <div>
                    <p>
                      {skill.name}{' '}
                      <span class="velion-trust-chip" aria-label={`Status: ${skill.enabled ? 'aktiv' : 'deaktivert'}`}>
                    ...
                    <Show when={skill.trigger_keywords.length > 0}>
                      <span class="velion-trust-chips">
                        <For each={skill.trigger_keywords}>
                          {(keyword) => <span class="velion-trust-chip">{keyword}</span>}
                        </For>
                      </span>
                    </Show>
                  </div>
      ...
      >
        <form class="velion-settings-field-grid velion-settings-field-grid--spaced" onSubmit={handleCreate}>
          <label for="skill-name" class="velion-settings-field">
          ...
          <label for="skill-description" class="velion-settings-field">
          ...
          <label for="skill-keywords" class="velion-settings-field">
            <span class="velion-settings-label">Utløser-nøkkelord</span>
            <span class="velion-settings-input-wrap">
              <VelionInput
                id="skill-keywords"
                value={keywords()}
          ...
          <label for="skill-content" class="velion-settings-field">
            <span class="velion-settings-label">Innhold (markdown)</span>
            <span class="velion-settings-input-wrap">
              <textarea
                id="skill-content"
                value={content()}
