  ...
  return (
    <>
      <SectionHeader
        ...
        description={i18n.tr(
          'Dette er hva Velion har lagret om deg på tvers av alle samtaler — ikke bare denne. Slett et minne du ikke lenger vil at agenten skal huske.',
          'This is what Velion has stored about you across every conversation — not just this one. Delete anything you no longer want the agent to remember.',
        )}
      />
      ...
      >
        <Show when={degraded() && list().length === 0}>
          <p class="velion-settings-subnote" role="status">
            {i18n.tr(
            ...
            <Show when={!degraded()}>
              <div class="velion-settings-list-card">
                <p class="velion-settings-empty-row">
                  {i18n.tr(
                    'Velion har ikke lagret noen minner om deg ennå. Etter hvert som du chatter, kan fakta og preferanser du deler begynne å dukke opp her.',
                    'Velion has not stored any memories about you yet. As you chat, facts and preferences you share may start showing up here.',
                  )}
                </p>
              </div>
            </Show>
