    ...
    >
			...
			>
				{logoMarks.map((logo, index) => (
					<span
						className={[
							"inline-flex min-w-max flex-none items-center justify-center leading-none opacity-85 saturate-[0.2] text-[color-mix(in_srgb,var(--velion-j-text)_62%,transparent)]",
