import { VelionMarkOutline } from "../sections/VelionMark";
 ...
 *
 * Uses velion-hero-approved-action.mp4 rather than the plain premiere-light
		...
		>
			...
			>
				<video
					...
					muted
					playsInline
					poster="/velion-vibe/velion-hero-approved-action-poster.jpg"
					preload="metadata"
				>
					<source
						src="/velion-vibe/velion-hero-approved-action.mp4"
						type="video/mp4"
					/>
				</video>
			</div>
