...
import { VelionShortShowcaseStage } from "@/components/showcase/VelionShortShowcase";
import { Reveal } from "../sections/Reveal";

export function ShowcaseShortSectionV2() {
	return (
		<section
			className="relative z-[70] isolate overflow-hidden border-y border-white/10 bg-[#2f3331] text-velion-c-white"
			id="showcase-short"
		>
			<div
				aria-hidden="true"
			...
			<div className="relative z-[2] flex min-h-svh items-center justify-center overflow-hidden">
				<Reveal className="flex min-h-svh w-full items-center justify-center">
					<VelionShortShowcaseStage
						ariaLabel="Kodet Velion-produktfilm med 3D arbeidsflyt."
						variant="viewport"
					/>
				</Reveal>
			</div>
