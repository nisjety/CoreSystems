...
/**
 * VelionHomeV2 — calmer, premium homepage variant.
 *
...
export function VelionHomeV2() {
	...
	return (
		<div
			className="min-h-screen bg-background text-velion-text [--velion-edge:clamp(56px,5.55vw,208px)] [--velion-page-pad:clamp(24px,4vw,56px)] [--velion-section-vpad:clamp(88px,12vh,156px)]"
			ref={homeRef}
		>
			<Preloader />
