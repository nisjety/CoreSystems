...
function LogoMark({ system }: { system: SystemLogo }) {
	return (
		<span
			...
			className="grid size-11 place-items-center rounded-[14px] border border-velion-j-text/8 bg-white p-2.5 shadow-[0_8px_18px_rgba(23,23,23,0.04)]"
			role="img"
			title={system.label}
		>
			<Image
	...
	return (
		<div className="min-h-screen bg-background text-velion-text [--velion-edge:clamp(32px,5.55vw,208px)] [--velion-page-pad:clamp(20px,4vw,56px)] [--velion-section-vpad:clamp(80px,11vw,160px)]">
			...
			<main>
				...
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-x-[clamp(44px,7.2vw,138px)] gap-y-12 xl:grid-cols-[minmax(0,0.9fr)_minmax(520px,1.1fr)]">
						<div className="max-w-[700px]">
							<p className="velion-eyebrow !text-[#686867]">Plattform / Felles kontekst</p>
							<h1 className="velion-display mt-7 max-w-[10ch] text-balance">
								Felles kontekst, før neste overlevering.
							</h1>
							<p className="velion-body-lg mt-8 max-w-[52ch] text-pretty">
								Velion samler historikken, kunnskapen og det som må skje videre — på tvers av arbeidsflatene dere allerede bruker.
							</p>
							<p className="mt-5 max-w-[54ch] font-protokoll text-[var(--text-body)] font-light leading-[1.55] text-velion-j-text/60 text-pretty">
								Dere trenger ikke å bytte ut verdenen deres for å bruke Velion. Dere får et felles utgangspunkt for samtalen, grunnlaget og neste steg.
							</p>

							<div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-5">
								<ArrowButton href="#eksempel">Se et eksempel</ArrowButton>
								<Link
									className="font-protokoll text-[0.92rem] font-light text-velion-j-text/62 underline-offset-4 transition-colors hover:text-velion-j-text hover:underline"
									href="/#kunnskap"
								>
				...
				<section
					aria-label="Systemer Velion kan samle i arbeidskonteksten"
					className="border-b border-velion-j-text/8 px-[var(--velion-edge)] py-[clamp(34px,4vw,56px)] max-[760px]:px-[var(--velion-page-pad)]"
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-7 lg:grid-cols-[minmax(250px,0.72fr)_minmax(0,1fr)]">
						<p className="m-0 max-w-[27ch] font-protokoll text-[0.9rem] font-light leading-[1.45] text-velion-j-text/62">
				...
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-x-[clamp(48px,8vw,150px)] gap-y-12 xl:grid-cols-[minmax(0,0.88fr)_minmax(480px,1.12fr)]">
						<div className="max-w-[580px]">
							<p className="velion-eyebrow !text-[#686867]">Synlig grunnlag</p>
							<h2 className="velion-h2 mt-6 max-w-[13ch] text-balance">
								Kontekst som forklarer seg selv.
							</h2>
							<p className="velion-body-lg mt-7 max-w-[50ch] text-pretty">
							...
							<ul className="m-0 mt-9 grid list-none gap-0 border-t border-velion-j-text/12 p-0">
								{[
									...
									<li
										className="grid grid-cols-[auto_1fr] gap-4 border-b border-velion-j-text/12 py-4 font-protokoll text-[0.94rem] font-light leading-[1.45] text-velion-j-text/66"
										key={item}
									>
							...
							<div className="absolute bottom-5 left-5 right-5 rounded-[20px] border border-white/82 bg-white/94 p-5 shadow-[0_18px_50px_rgba(23,23,23,0.16)] backdrop-blur-md sm:bottom-7 sm:left-7 sm:right-7">
								<div className="flex items-start justify-between gap-4">
									<div>
										...
										<p className="m-0 mt-1.5 font-arbeit text-[1.1rem] tracking-[-0.035em] text-velion-j-text">
											Returpolicy 04
										</p>
									</div>
									<span className="rounded-full bg-velion-surface-soft px-2.5 py-1 font-protokoll text-[0.68rem] text-velion-j-text/62">
										Oppdatert i går
									</span>
								</div>
				...
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-x-[clamp(48px,8vw,150px)] gap-y-12 xl:grid-cols-[minmax(0,0.86fr)_minmax(480px,1.14fr)]">
							...
							<ul className="m-0 mt-9 grid list-none border-t border-white/16 p-0">
								{[
									...
									<li className="grid grid-cols-[auto_1fr] gap-4 border-b border-white/16 py-4 font-protokoll text-[0.94rem] font-light text-white/66" key={item}>
										<span className="text-velion-coral">0{index + 1}</span>
										<span>{item}</span>
									</li>
								))}
							</ul>
						...
						<figure className="relative min-h-[480px] overflow-hidden rounded-[30px] border border-white/12 bg-white/8">
							...
							/>
							<div className="absolute bottom-5 left-5 right-5 rounded-[20px] border border-white/82 bg-white/94 p-5 text-velion-j-text shadow-[0_18px_50px_rgba(0,0,0,0.28)] backdrop-blur-md sm:bottom-7 sm:left-7 sm:right-7">
								<p className="m-0 font-protokoll text-[0.65rem] font-medium uppercase tracking-[0.16em] text-velion-j-text/64">
				...
				<section className="px-[var(--velion-edge)] py-[clamp(92px,12vw,180px)] max-[760px]:px-[var(--velion-page-pad)]">
					<div className="mx-auto grid max-w-[1680px] gap-10 border-t border-velion-j-text/12 pt-[clamp(38px,5vw,72px)] xl:grid-cols-[minmax(0,1fr)_auto] xl:items-end">
						<div>
							<p className="velion-eyebrow !text-[#686867]">Resultatet</p>
