...
const decisionOutcomes: Record<Decision, DecisionOutcome> = {
	...
	manual: {
		...
		description:
			"Forslaget er lagt til side. Dere kan fortsette arbeidet selv, uten at Velion utfører en handling på deres vegne.",
		audit: "Beslutning registrert i demonstrasjonen · Ingen automatisert handling utført",
		className: "border-velion-j-text/14 bg-velion-j-text/[0.055] text-velion-j-text",
	},
};
	...
	return (
		<div className="absolute bottom-[clamp(18px,2.4vw,34px)] left-[clamp(18px,2.4vw,34px)] right-[clamp(18px,2.4vw,34px)] rounded-[22px] border border-white/80 bg-white/94 p-[clamp(16px,2vw,24px)] shadow-[0_24px_64px_rgba(23,23,23,0.16)] backdrop-blur-md">
			<div className="flex items-start justify-between gap-5">
				<div>
					<p className="m-0 font-protokoll text-[0.65rem] font-medium uppercase tracking-[0.16em] text-velion-j-text/64">
						Klar for beslutning
					</p>
					<p className="m-0 mt-2 font-arbeit text-[clamp(1.1rem,1.55vw,1.45rem)] font-normal leading-[1.04] tracking-[-0.04em] text-velion-j-text">
			...
			<div className="mt-4 grid gap-2 border-t border-velion-j-text/8 pt-3 font-protokoll text-[0.78rem] font-light text-velion-j-text/62 sm:grid-cols-2">
...
export function ControlledWorkPage() {
	...
	return (
		<div className="min-h-screen bg-background text-velion-text [--velion-edge:clamp(32px,5.55vw,208px)] [--velion-page-pad:clamp(20px,4vw,56px)] [--velion-section-vpad:clamp(80px,11vw,160px)]">
			<ControlledWorkHeader />

			<main>
				<section
					className="border-b border-velion-j-text/8 px-[var(--velion-edge)] pb-[clamp(72px,9vw,144px)] pt-[clamp(74px,10vw,148px)] max-[760px]:px-[var(--velion-page-pad)]"
					id="top"
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-x-[clamp(44px,7.2vw,138px)] gap-y-12 xl:grid-cols-[minmax(0,0.9fr)_minmax(520px,1.1fr)]">
						<div className="max-w-[700px]">
							<p className="velion-eyebrow !text-[#686867]">Plattform / Kontrollert arbeid</p>
							<h1 className="velion-display mt-7 max-w-[10ch] text-balance">
								Arbeid som kan forklares før det skjer.
							</h1>
							<p className="velion-body-lg mt-8 max-w-[48ch] text-pretty">
								Velion foreslår. Dere bestemmer.
							</p>
							<p className="mt-5 max-w-[54ch] font-protokoll text-[var(--text-body)] font-light leading-[1.55] text-velion-j-text/60 text-pretty">
							...
							<div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-5">
								...
								<a
									className="font-protokoll text-[0.92rem] font-light text-velion-j-text/62 underline-offset-4 transition-colors hover:text-velion-j-text hover:underline focus-visible:text-velion-j-text focus-visible:outline-none"
									href="#grenser"
								>
									Se grensene
								</a>
						...
						<figure className="relative isolate min-h-[420px] overflow-hidden rounded-[30px] border border-velion-j-text/8 bg-velion-surface-soft shadow-[0_32px_100px_rgba(23,23,23,0.10)] sm:min-h-[520px]">
							<Image
				...
				>
					<div className="mx-auto grid max-w-[1680px] items-start gap-x-[clamp(48px,8vw,150px)] gap-y-12 xl:grid-cols-[minmax(0,0.74fr)_minmax(560px,1.26fr)]">
						<div className="max-w-[580px] xl:sticky xl:top-[120px]">
							<p className="velion-eyebrow !text-[#686867]">Et konkret forslag</p>
							<h2 className="velion-h2 mt-6 max-w-[12ch] text-balance">
								Grunnlaget er der før avgjørelsen.
							</h2>
							<p className="velion-body-lg mt-7 max-w-[48ch] text-pretty">
							...
							<p className="mt-6 max-w-[49ch] font-protokoll text-[var(--text-body)] font-light leading-[1.55] text-velion-j-text/62 text-pretty">
						...
						<article
							...
							className="overflow-hidden rounded-[28px] border border-velion-j-text/12 bg-white shadow-[0_26px_80px_rgba(23,23,23,0.08)]"
						>
							<div className="flex flex-wrap items-start justify-between gap-5 border-b border-velion-j-text/10 px-[clamp(20px,3vw,36px)] py-[clamp(18px,2.4vw,28px)]">
								<div>
									<p className="m-0 font-protokoll text-[0.68rem] font-medium uppercase tracking-[0.16em] text-velion-j-text/64">
										Forslag til handling
									</p>
									<h3 className="m-0 mt-2 font-arbeit text-[clamp(1.65rem,2.25vw,2.4rem)] font-light leading-[0.98] tracking-[-0.05em] text-velion-j-text" id="decision-card-title">
							...
							<div className="grid gap-0 lg:grid-cols-[minmax(0,1.02fr)_minmax(250px,0.78fr)]">
								<div className="p-[clamp(20px,3vw,36px)]">
									<p className="m-0 font-protokoll text-[0.78rem] font-medium uppercase tracking-[0.12em] text-velion-j-text/64">
										Hva forslaget gjør
									</p>
									<p className="m-0 mt-3 max-w-[47ch] font-protokoll text-[clamp(1.02rem,1.3vw,1.2rem)] font-light leading-[1.5] text-velion-j-text/76" id="decision-card-description">
									...
									<blockquote className="m-0 mt-8 rounded-[18px] border border-velion-j-text/8 bg-velion-surface-soft px-5 py-5 font-protokoll text-[0.94rem] font-light leading-[1.5] text-velion-j-text/70">
										<p className="m-0 text-[0.67rem] font-medium uppercase tracking-[0.15em] text-velion-j-text/64">
											Kundehenvendelse
										</p>
									...
									<div className="mt-8 border-t border-velion-j-text/10 pt-5">
										<p className="m-0 font-protokoll text-[0.68rem] font-medium uppercase tracking-[0.16em] text-velion-j-text/64">
											Beslutningsroller i eksempelet
										</p>
										<div className="mt-3 grid gap-2.5 font-protokoll text-[0.88rem] font-light leading-[1.4] text-velion-j-text/62 sm:grid-cols-3">
											<div className="rounded-xl border border-velion-j-text/8 px-3.5 py-3">
												<span className="block text-[0.66rem] font-medium uppercase tracking-[0.12em] text-velion-j-text/64">Godkjenner</span>
												<span className="mt-1 block text-velion-j-text/76">Nora H.</span>
											</div>
											<div className="rounded-xl border border-velion-j-text/8 px-3.5 py-3">
												<span className="block text-[0.66rem] font-medium uppercase tracking-[0.12em] text-velion-j-text/64">Reviderer</span>
												<span className="mt-1 block text-velion-j-text/76">Kundeteamet</span>
											</div>
											<div className="rounded-xl border border-velion-j-text/8 px-3.5 py-3">
												<span className="block text-[0.66rem] font-medium uppercase tracking-[0.12em] text-velion-j-text/64">Stopper</span>
												<span className="mt-1 block text-velion-j-text/76">Ansvarlig leder</span>
											</div>
										</div>
									</div>
								</div>

								<aside className="border-t border-velion-j-text/10 bg-velion-surface-soft p-[clamp(20px,3vw,32px)] lg:border-l lg:border-t-0" aria-label="Grunnlaget for forslaget">
									<p className="m-0 font-protokoll text-[0.68rem] font-medium uppercase tracking-[0.16em] text-velion-j-text/64">
										Grunnlag
									</p>
									<dl className="m-0 mt-4 grid gap-0 border-t border-velion-j-text/10">
										{proofRows.map((item) => (
											<div className="border-b border-velion-j-text/10 py-4" key={item.label}>
												<dt className="font-protokoll text-[0.67rem] font-medium uppercase tracking-[0.12em] text-velion-j-text/64">{item.label}</dt>
												<dd className="m-0 mt-1.5 font-protokoll text-[0.84rem] font-light leading-[1.45] text-velion-j-text/68">{item.value}</dd>
											</div>
										))}
									</dl>
								</aside>
							...
							<div className="border-t border-velion-j-text/10 px-[clamp(20px,3vw,36px)] py-[clamp(20px,3vw,30px)]">
								<p className="m-0 font-protokoll text-[0.68rem] font-medium uppercase tracking-[0.16em] text-velion-j-text/64">
									Velg neste steg
								</p>
									...
									{decisionOptions.map((option) => {
										...
										return (
											<button
												...
												className={[
													"group min-h-[124px] rounded-[17px] border p-4 text-left transition-[background-color,border-color,color,transform] duration-300 ease-out motion-reduce:transform-none motion-reduce:transition-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-velion-j-text",
													isSelected
														? "border-velion-j-text bg-velion-j-text text-white"
														: "border-velion-j-text/12 bg-white text-velion-j-text hover:-translate-y-0.5 hover:border-velion-j-text/30 hover:bg-velion-surface-soft",
												].join(" ")}
											...
											>
												...
												<span className={[
													...
													isSelected ? "text-white/66" : "text-velion-j-text/62",
								...
								<div aria-live="polite" className="mt-4 min-h-[96px]">
									{outcome ? (
										...
										<p className="m-0 flex min-h-[96px] items-center rounded-[17px] border border-dashed border-velion-j-text/15 px-4 font-protokoll text-[0.83rem] font-light leading-[1.45] text-velion-j-text/62">
				...
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-x-[clamp(48px,8vw,150px)] gap-y-12 xl:grid-cols-[minmax(0,0.88fr)_minmax(480px,1.12fr)]">
						<div className="max-w-[580px]">
							<p className="velion-eyebrow !text-[#686867]">Etterpåvisning</p>
							<h2 className="velion-h2 mt-6 max-w-[12ch] text-balance">
								Se hvorfor forslaget kom.
							</h2>
							<p className="velion-body-lg mt-7 max-w-[49ch] text-pretty">
							...
							<ul className="m-0 mt-9 grid list-none gap-0 border-t border-velion-j-text/12 p-0">
								{[
									...
									<li className="grid grid-cols-[auto_1fr] gap-4 border-b border-velion-j-text/12 py-4 font-protokoll text-[0.94rem] font-light leading-[1.45] text-velion-j-text/66" key={item}>
										<span className="font-medium text-velion-coral">0{index + 1}</span>
										<span>{item}</span>
									</li>
								))}
							</ul>
						...
						<figure className="relative min-h-[480px] overflow-hidden rounded-[30px] border border-velion-j-text/8 bg-velion-surface-soft shadow-[0_24px_80px_rgba(23,23,23,0.08)]">
							<Image
							...
							<div className="absolute bottom-5 left-5 right-5 rounded-[20px] border border-white/82 bg-white/94 p-5 shadow-[0_18px_50px_rgba(23,23,23,0.16)] backdrop-blur-md sm:bottom-7 sm:left-7 sm:right-7">
								<div className="flex flex-wrap items-start justify-between gap-3">
									<div>
										...
										<p className="m-0 mt-1.5 font-arbeit text-[1.12rem] tracking-[-0.035em] text-velion-j-text">
											Returpolicy 04 · avsnitt 3
										</p>
									</div>
									<time className="rounded-full bg-velion-surface-soft px-2.5 py-1 font-protokoll text-[0.68rem] text-velion-j-text/62" dateTime="2026-07-14T09:18:00+02:00">
										Oppdatert 14. juli
									</time>
								</div>
								<p className="m-0 mt-4 font-protokoll text-[0.85rem] font-light leading-[1.45] text-velion-j-text/62">
				...
				<section
					className="overflow-hidden bg-velion-j-text px-[var(--velion-edge)] py-[var(--velion-section-vpad)] text-white max-[760px]:px-[var(--velion-page-pad)]"
					id="grenser"
				>
					<div className="mx-auto grid max-w-[1680px] items-center gap-x-[clamp(48px,8vw,150px)] gap-y-12 xl:grid-cols-[minmax(0,0.88fr)_minmax(480px,1.12fr)]">
						<div className="max-w-[585px]">
							...
							<h2 className="mt-6 max-w-[12ch] font-arbeit text-[clamp(2.45rem,4.1vw,5rem)] font-light leading-[0.94] tracking-[-0.06em] text-white text-balance">
								Velion kan ikke utvide egne rettigheter.
							</h2>
							<p className="mt-7 max-w-[50ch] font-protokoll text-[var(--text-body-lg)] font-light leading-[1.52] text-white/64 text-pretty">
								Velion kan forberede arbeidet innenfor den tilgangen og arbeidsflyten dere har definert. Det kan ikke gi seg selv flere systemer, roller eller handlingsrom.
							</p>
							<ul className="m-0 mt-9 grid list-none border-t border-white/16 p-0">
								{[
									{
										title: "Tilgang kommer fra dere",
										body: "Det som ikke er koblet til eller gitt tilgang til, er ikke en ny snarvei Velion kan opprette selv.",
									},
									{
									...
									<li className="grid grid-cols-[auto_1fr] gap-4 border-b border-white/16 py-5" key={item.title}>
										<span className="pt-0.5 font-protokoll text-[0.8rem] font-medium text-velion-coral">0{index + 1}</span>
										<div>
						...
						<figure className="relative min-h-[480px] overflow-hidden rounded-[30px] border border-white/12 bg-white/8">
							...
							/>
							<div className="absolute bottom-5 left-5 right-5 rounded-[20px] border border-white/18 bg-velion-j-text/72 p-5 shadow-[0_18px_50px_rgba(0,0,0,0.26)] backdrop-blur-md sm:bottom-7 sm:left-7 sm:right-7">
				...
				<section className="px-[var(--velion-edge)] py-[clamp(92px,12vw,180px)] max-[760px]:px-[var(--velion-page-pad)]">
					<div className="mx-auto grid max-w-[1680px] gap-10 border-t border-velion-j-text/12 pt-[clamp(38px,5vw,72px)] xl:grid-cols-[minmax(0,1fr)_auto] xl:items-end">
						<div>
							<p className="velion-eyebrow !text-[#686867]">Arbeidet deres</p>
							<h2 className="velion-h2 mt-6 max-w-[14ch] text-balance">
								Mer framdrift. Samme ansvar.
							</h2>
							<p className="mt-6 max-w-[52ch] font-protokoll text-[var(--text-body)] font-light leading-[1.55] text-velion-j-text/60 text-pretty">
								Velion kan gjøre neste steg tydeligere. Det menneskelige ansvaret og rammene blir værende hos dere.
							</p>
						</div>
