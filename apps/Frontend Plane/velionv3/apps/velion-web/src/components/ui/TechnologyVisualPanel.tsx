export function TechnologyVisualPanel() {
	return (
		<div
			aria-label="Velion technology visual"
			className="relative min-h-[96svh] overflow-hidden bg-[#f2f2ef] text-velion-j-text max-[1100px]:min-h-[720px] max-[760px]:min-h-[640px]"
			role="img"
		>
			<div
				aria-hidden="true"
			...
			>
				...
				<div className="absolute right-[39%] top-[45%] h-px w-[22%] rotate-[5deg] bg-velion-j-text/12 blur-[0.4px]" />
				<div className="absolute right-[34%] top-[48%] size-2 rounded-full bg-velion-j-text/80" />
				<div className="absolute right-[30%] top-[51%] size-2 rounded-full bg-velion-j-text/80" />
				<div className="absolute right-[26%] top-[54%] size-2 rounded-full bg-velion-j-text/80" />
			</div>
			...
			<div className="relative z-[2] flex min-h-[96svh] flex-col justify-between px-[clamp(28px,4vw,72px)] pb-[clamp(42px,5vw,74px)] pt-[clamp(56px,7vw,92px)] max-[1100px]:min-h-[720px] max-[760px]:min-h-[640px]">
				<div>
					<h2 className="m-0 max-w-[760px] font-arbeit text-[clamp(3.2rem,4.6vw,6rem)] font-light leading-[0.96] tracking-[-0.07em] text-velion-j-text/20">
						Pioneering technology
					</h2>

					<p className="m-0 mt-7 max-w-[560px] font-protokoll text-[clamp(1rem,1vw,1.18rem)] font-light leading-[1.45] text-velion-j-text/38">
						Velion turns monitored signals into source-backed briefs,
				...
				<div className="grid w-full max-w-[980px] grid-cols-3 gap-[clamp(18px,2vw,34px)] max-[760px]:grid-cols-1">
					<div>
						<strong className="font-arbeit text-[clamp(2.1rem,2.2vw,3.1rem)] font-light leading-none tracking-[-0.055em] text-velion-j-text/88">
							<span className="mr-2 text-[0.82em]">›</span>4{" "}
							<sup className="relative top-[-0.14em] font-protokoll text-[0.38em] font-light tracking-normal text-velion-j-text/72">
								steps
							</sup>
						</strong>
						<span className="mt-4 block font-protokoll text-[clamp(0.95rem,0.95vw,1.08rem)] font-light leading-[1.3] text-velion-j-text/48">
							AI worker loop
						</span>
						<span className="mt-8 block h-px w-full bg-velion-j-text/18" />
					</div>
			...
			<div className="pointer-events-none absolute bottom-[18%] right-[8%] z-[3] w-[min(34vw,560px)] opacity-[0.34] mix-blend-multiply max-[1100px]:bottom-[30%] max-[1100px]:right-[8%] max-[1100px]:w-[min(54vw,560px)] max-[760px]:hidden">
				<div className="rounded-xl bg-white/20 p-4">
					<svg
						className="text-velion-j-text/55"
						height="100%"
						viewBox="0 0 200 100"
						width="100%"
					>
						<style>
							{`
								.cpu-architecture {
									...
									animation-name: velion-cpu-animation-path;
								...
								@keyframes velion-cpu-animation-path {
									from {
										offset-distance: 0%;
									}
