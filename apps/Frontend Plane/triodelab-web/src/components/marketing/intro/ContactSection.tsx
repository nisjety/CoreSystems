            ...
            >
              ...
              <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
                <div className="flex flex-col gap-2">
                   <label htmlFor="contact-navn" className="text-xs font-bold uppercase tracking-wider text-gray-400">Navn</label>
                   <input id="contact-navn" type="text" className="border-b border-gray-300 py-2 outline-none focus:border-black transition-colors bg-transparent placeholder:text-gray-300" placeholder="Ola Nordmann" />
                </div>
                
                <div className="flex flex-col gap-2">
                   <label htmlFor="contact-epost" className="text-xs font-bold uppercase tracking-wider text-gray-400">E-post</label>
                   <input id="contact-epost" type="email" className="border-b border-gray-300 py-2 outline-none focus:border-black transition-colors bg-transparent placeholder:text-gray-300" placeholder="ola@bedrift.no" />
                </div>

                <div className="flex flex-col gap-2">
                   <label htmlFor="contact-melding" className="text-xs font-bold uppercase tracking-wider text-gray-400">Hva handler det om?</label>
                   <textarea id="contact-melding" rows={3} className="border-b border-gray-300 py-2 outline-none focus:border-black transition-colors bg-transparent resize-none placeholder:text-gray-300" placeholder="Kort om prosjektet..." />
                </div>
