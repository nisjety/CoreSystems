                                ...
                                <div className="p-8">
                                    ...
                                    <div className="grid grid-cols-3 gap-8">
                                        ...
                                        <div className="col-span-1 border-r border-[#282A22]/10 pr-8">
                                            ...
                                            <Link href="/demo" className="inline-flex items-center justify-center px-4 py-2 bg-[#282A22]/5 hover:bg-[#282A22]/10 text-[#282A22] font-light rounded-full text-sm transition-colors group">
                                                Try the Demo
                                        ...
                                        <div className="col-span-2 grid grid-cols-2 gap-x-12 gap-y-8">
                                            <div>
                                                ...
                                                <ul className="space-y-4">
                                                    <li>
                                                        <Link href="/products/checking" className="group flex flex-col gap-1">
                                                    ...
                                                    <li>
                                                        <Link href="/products/working-capital" className="group flex flex-col gap-1">
                                                            <span className="text-[#282A22] font-light tracking-wide group-hover:text-blue-600 transition-colors flex items-center">
                                                                Working Capital
                                                                <ArrowRight className="w-4 h-4 ml-2 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all text-blue-600" />
                                                            </span>
                                            ...
                                            <div>
                                                ...
                                                <ul className="space-y-4">
                                                    <li>
                                                        <Link href="/integrations/accounting" className="group flex flex-col gap-1">
                                                            <span className="text-[#282A22] font-light tracking-wide group-hover:text-blue-600 transition-colors flex items-center">
