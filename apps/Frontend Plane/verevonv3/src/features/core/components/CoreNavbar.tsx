...
/** The support queue owns `/` whenever its persistent local search is present. */
export function shouldDeferGlobalSlashSearch(): boolean {
  return document.getElementById('verevon-inbox-search') instanceof HTMLInputElement
}
...
function GlobalSearchDialog(props: {
  ...
  return (
    <div class="core-search-overlay" role="dialog" aria-modal="true" aria-label={i18n.tr('Kunnskapssøk', 'Knowledge search')}>
      ...
      <div class="core-search-overlay__panel verevon-panel-in">
...
function SearchTrigger(props: { onOpen: () => void }) {
  ...
  return (
    <button
      ...
      class="verevon-navbar-search-trigger"
      aria-label={i18n.tr('Åpne kunnskapssøk', 'Open knowledge search')}
    >
      <Search class="verevon-navbar-search-icon" strokeWidth={1.8} />
      <span class="verevon-navbar-search-label">{i18n.tr('Søk i kunnskapsbasen', 'Search knowledge base')}</span>
      <span class="verevon-navbar-shortcut-key verevon-navbar-shortcut-key-min">/</span>
      <span class="verevon-navbar-shortcut-key verevon-navbar-shortcut-key-wide">CMD+K</span>
    </button>
  )
}
...
function NavbarActionButton(props: {
  ...
  return (
    <button
      ...
      class={cn('verevon-navbar-action-button', props.class)}
    >
      {props.children}
    </button>
  )
