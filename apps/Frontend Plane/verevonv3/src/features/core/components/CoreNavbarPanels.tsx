...
export function CoreNavbarPanel(props: {
  ...
  onNavigate: (href: VerevonRoute) => void
  onRefresh?: () => void
  onSignOut: () => void
  onSupport: () => void
...
function MessagesDropdown(props: {
  ...
  const i18n = useI18n()
  return (
    <Panel class="right-24 verevon-floating-panel-md">
      <TabHeader tabs={[i18n.tr('Alle', 'All'), i18n.tr('Meldinger', 'Messages'), i18n.tr('Omtaler', 'Mentions')]} />
      <div class="max-h-[380px] overflow-y-auto">
        <Show when={props.configured} fallback={<EmptyPanel text={i18n.tr('Koble til Novu for å vise innboks og Verevon AI-chatmeldinger.', 'Connect Novu to show inbox and Verevon AI chat messages.')} />}>
...
function NotificationsDropdown(props: {
  ...
  const i18n = useI18n()
  return (
    <Panel class="right-14 verevon-floating-panel-md">
...
function CalendarDropdown(props: {
  ...
  return (
    <Panel class="right-6 verevon-floating-panel-md">
...
function ProfileDropdown(props: {
  ...
  const i18n = useI18n()
  return (
    <Panel class="right-0 verevon-floating-panel-sm p-2">
      ...
      <button type="button" onClick={() => props.onSupport()} class="verevon-menu-item">
        <HelpCircle class="size-[17px]" strokeWidth={1.7} />
        <span>{i18n.tr('Hjelpesenter', 'Help center')}</span>
      </button>
      <button type="button" class="verevon-menu-item" onClick={() => props.onSignOut()}>
...
function AssistantPanel(props: { onNavigate: (href: VerevonRoute) => void }) {
  const i18n = useI18n()
  return (
    <Panel class="right-32 verevon-floating-panel-sm p-3">
...
function ProfileItem(props: {
  ...
  return (
    <button type="button" onClick={() => props.onNavigate(props.href)} class="verevon-menu-item">
...
function Panel(props: { children: JSX.Element; class?: string }) {
  return <div class={cn('verevon-popover verevon-floating-panel core-navbar-panel', props.class)}>{props.children}</div>
}
