...
export function searchRailTips(activeTab: SearchResultTab, locale: Locale = 'no'): string[] {
  ...
  switch (activeTab) {
    case 'Map':
      return no
        ? [
            ...
            'Verevon kan gjøre stedstreff om til en kort rute eller besøksplan når kartdata finnes.',
          ]
        : [
    ...
    case 'Images':
      return no
        ? [
            'Bilder behandles som visuelt bevis, ikke endelige svar, til Verevon kan sitere kildesiden.',
            'Verevon kan forklare produkt-, sted-, layout- eller skjermbildedetaljer fra bildekonteksten.',
          ]
        : [
    ...
    case 'Videos':
      return no
        ? [
            ...
            'Verevon kan hente ut nyttige øyeblikk før hele klippet anbefales.',
          ]
        : [
    ...
    case 'Shopping':
      return no
        ? [
            ...
            'Verevon kan sammenligne pris, tilgjengelighet, kildetrygghet og lignende alternativer.',
          ]
        : [
    ...
    default:
      return no
        ? [
            ...
            'Still et oppfølgingsspørsmål for å få Verevon til å snevre inn, sammenligne, crawle eller oppsummere treffene.',
          ]
        : [
