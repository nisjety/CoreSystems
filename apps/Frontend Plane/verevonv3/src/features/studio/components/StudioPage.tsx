...
function StudioCanvasPage() {
  ...
  return (
    <div class="verevon-studio-page">
      <div class="verevon-studio-board-shell">
        <header class="verevon-studio-topbar">
          <div class="verevon-studio-profile">
          ...
          <div class="verevon-studio-topbar__actions">
            <button
              type="button"
              class="verevon-studio-pill-button"
            ...
            <button
              type="button"
              class={cn('verevon-studio-publish-button', persistenceSource() === 'live' && 'is-live')}
        ...
        <main class="verevon-studio-canvas-wrap" aria-label={i18n.tr('Studio-lerretsarbeidsområde', 'Studio canvas workspace')}>
          <div
            ref={canvasRef}
            class={cn(
              'verevon-studio-canvas',
              drag() && 'is-drop-active',
          ...
          >
            ...
            <Show when={selectedBlock()}>
              {(block) => (
                <div
                  class="verevon-studio-block-toolbar"
                ...
                >
                  <span class="verevon-studio-block-toolbar__handle" aria-hidden="true">
            ...
            <Show when={!blocks().length}>
              <div class="verevon-studio-empty-state">
                <span>
                  <Plus size={20} />
                </span>
        ...
        <div class="verevon-studio-undo" aria-label={i18n.tr('Historikkontroller for lerret', 'Canvas history controls')}>
        ...
        <div class="verevon-studio-dock" aria-label={i18n.tr('Legg til lerretblokker', 'Add canvas blocks')}>
        ...
        <div class="verevon-studio-device-switch" aria-label={i18n.tr('Forhåndsvisningsenhet', 'Preview device')}>
          <button
            type="button"
        ...
        <div class="verevon-studio-preview-actions">
          <button type="button">
            <Eye size={16} />
        ...
        <aside class="verevon-studio-inspector">
          <Show when={selectedBlock()} fallback={<p>{i18n.tr('Velg en blokk', 'Select a block')}</p>}>
            {(block) => (
              <>
                <span class="verevon-studio-inspector__eyebrow">{block().kind}</span>
                <label>
                ...
                <div class="verevon-studio-inspector__layout">
                  <label>
                    X
...
function StudioCanvasBlock(props: {
  ...
  return (
    <article
      class={cn(
        'verevon-studio-block',
        `verevon-studio-block--${props.block.kind}`,
    ...
    >
      <div class="verevon-studio-block__surface">
        <Switch>
          ...
          <Match when={props.block.kind === 'video'}>
            <div class="verevon-studio-video-preview">
              <Video size={34} />
            </div>
            <strong>{props.block.title}</strong>
            <p>{props.block.body}</p>
          ...
          <Match when={props.block.kind === 'social'}>
            <span class="verevon-studio-social-label">{i18n.tr('Sosialt innlegg', 'Social post')}</span>
            <strong>{props.block.title}</strong>
            <p>{props.block.body}</p>
          </Match>
      ...
      <Show when={props.selected}>
        <span class="verevon-studio-selection-handle is-nw" aria-hidden="true" />
        <span class="verevon-studio-selection-handle is-ne" aria-hidden="true" />
        <span class="verevon-studio-selection-handle is-sw" aria-hidden="true" />
        <span class="verevon-studio-selection-handle is-se" aria-hidden="true" />
        <span class="verevon-studio-block__size-pill">
...
function StudioLibraryPage(props: {
  ...
  return (
    <div class="verevon-studio-library-page">
      <section class="verevon-studio-library-hero">
