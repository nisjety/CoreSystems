...
export function KnowledgeOperatingMapCanvas(props: Props) {
  ...
  return (
    <main class="knowledge-operating-map">
      <section class="verevon-panel knowledge-operating-map-hero">
        <div>
      ...
      <Show when={props.loading}>
        <section class="verevon-panel knowledge-loading-panel">Loading Operating Map...</section>
      </Show>

      <Show when={!props.loading && !activeVersion()}>
        <section class="verevon-panel knowledge-operating-map-empty">
...
function ProposalReviewPanel(props: {
  ...
  return (
    <section class="verevon-panel knowledge-operating-map-review">
      <div>
    ...
    <section class="knowledge-operating-map-phase-grid">
      <For each={props.version.rolloutPhases}>
        {(phase) => {
          ...
          return (
            <article class="verevon-panel knowledge-operating-map-phase-card">
              <div>
                <Icon class="size-4" />
...
function WorkflowCard(props: {
  ...
  return (
    <article class="verevon-panel knowledge-operating-map-workflow-card">
...
function EvidenceInspector(props: {
  ...
  return (
    <section class="verevon-panel knowledge-operating-map-evidence-drawer" aria-label={`Evidence for ${props.workflow.name}`}>
...
function AgentBlueprintPanel(props: {
  ...
  return (
    <section>
      <SectionHeader title="Agent blueprint candidates" description="Approved workflows can become Verevon agent blueprints for service, sales, ecommerce, chatbot, or workflow roles." />
      <div class="knowledge-operating-map-blueprint-grid">
        <For each={props.version.agentBlueprints}>
          {(blueprint) => {
            ...
            return (
              <article class="verevon-panel knowledge-operating-map-blueprint-card">
                <div>
                  <Bot class="size-4" />
      ...
      <div>
        ...
        <div class="knowledge-operating-map-list">
          <For each={props.version.riskOverlays}>
            {(risk) => (
              <article class="verevon-panel knowledge-operating-map-list-card">
