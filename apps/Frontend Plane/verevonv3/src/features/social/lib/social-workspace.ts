...
export async function loadSocialContext(): Promise<SocialWorkspaceContext> {
  ...
  return {
    ...
    orgLabel: activeOrg?.name ?? ctx?.orgId ?? 'Verevon',
  }
}

export async function loadSocialCalendar(orgId: string, orgLabel = 'Verevon'): Promise<SocialCalendar> {
  return (await readSocialCalendar(orgId, orgLabel)).data
}

export async function loadSocialCalendarResource(orgId: string, orgLabel = 'Verevon'): Promise<ResourceResult<SocialCalendar>> {
...
export function fallbackSocialWorkspace(orgLabel = 'Verevon'): SocialWorkspace {
...
export function fallbackSocialCalendar(orgLabel = 'Verevon'): SocialCalendar {
  void orgLabel
