  ...
  return (
    <div class="verevon-social-ops-page">
      ...
      <Show when={workspace()?.orgId}>
        <section class="verevon-social-ops-metrics" aria-label={i18n.tr('Annonsestatistikk', 'Ad metrics')}>
          <Show
            when={metrics().length}
            fallback={
              <p class="verevon-social-ops-state">
      ...
      <Show when={workspace()?.orgId}>
        <section class="verevon-social-ops-grid" aria-label={i18n.tr('Handelskataloger', 'Commerce catalogs')}>
          <Show
      ...
      <Show when={selected()}>
        {(choice) => (
          <section class="verevon-social-ops-grid" aria-label={i18n.tr('Katalogprodukter', 'Catalog products')}>
