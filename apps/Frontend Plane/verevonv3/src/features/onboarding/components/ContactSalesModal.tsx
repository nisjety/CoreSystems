 ...
 * Verevon supports natively, so it is never a self-serve checkout — this
...
export function ContactSalesModal(props: ContactSalesModalProps) {
  ...
  const mailtoHref = () => {
    ...
    return `mailto:hei@verevon.ai?${params.toString()}`
  }
      ...
      >
        ...
        >
          ...
          <p style={{ margin: '0 0 12px', 'line-height': '1.5' }}>
            {i18n.tr(
              'Prisen for en tilpasset plan avhenger av behovene deres — hva Verevon allerede støtter ut av boksen, og hva som må bygges som en tilpasset integrasjon for dere.',
              'Custom plan pricing depends on your needs — what Verevon already supports natively out of the box, versus what would need to be built as a custom integration for you.',
            )}
          </p>
