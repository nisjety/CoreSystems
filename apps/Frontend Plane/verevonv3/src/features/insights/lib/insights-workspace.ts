  ...
  return [
    {
      ...
      detail: connectorDetail(
        ...
        'Connect a GA4 property before Verevon can request event and conversion reports.',
      ),
    ...
    },
    {
      ...
      detail: connectorDetail(
        ...
        'Connect Search Console before Verevon can read query and page performance.',
      ),
