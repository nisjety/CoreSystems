import { Bot, X } from '@/shared/icons'
            ...
            <For each={AGENT_AVATAR_COLORS}>
              {(candidate) => (
                <button
                  type="button"
                  role="radio"
                  aria-checked={color() === candidate ? 'true' : 'false'}
                  aria-label={candidate}
                  class={[
                    'verevon-space-create-agent__color',
                    { 'verevon-space-create-agent__color--selected': color() === candidate },
                  ]}
