...
export function PrivacyDataSection() {
  ...
  function downloadExport() {
    ...
    anchor.href = url
    anchor.download = `verevon-data-export-${data.subject_id}.json`
    anchor.click()
  ...
  return (
    <section id="privacy-data" class="verevon-settings-section">
      <SectionHeader
      ...
      <div class="verevon-privacy-disclosure">
        <p class="verevon-privacy-disclosure__title">{i18n.tr('Hva dette omfatter', 'What this covers')}</p>
        <ul>
          <For each={CONTROL_PLANE_DSAR_DISCLOSURE}>{(note) => <li>{note}</li>}</For>
        </ul>
      </div>

      <div class="verevon-privacy-block">
        <div class="verevon-privacy-block__head">
          ...
          <SettingsButton settingsSize="sm" onClick={() => void runExport()} disabled={exporting()}>
            ...
            >
              <Loader2 size={14} class="verevon-trust-spin" aria-hidden="true" /> {i18n.tr('Genererer…', 'Generating…')}
            </Show>
          </SettingsButton>
        </div>
        ...
        <Show when={exportData()}>
          {(data) => (
            <div class="verevon-privacy-export">
              <p class="verevon-privacy-export__summary">
              ...
              <ul class="verevon-privacy-export__notes">
      ...
      <div class="verevon-privacy-danger">
        <div class="verevon-privacy-block__head">
          <h3>
        ...
        <Show when={showErase()}>
          <form class="verevon-privacy-erase-form" onSubmit={runErase}>
            <label>
            ...
            <div class="verevon-privacy-erase-actions">
              ...
              <SettingsButton type="submit" settingsSize="sm" danger disabled={!canErase()}>
                <Show when={erasing()} fallback={<>{i18n.tr('Slett kontoen min permanent', 'Permanently erase my account')}</>}>
                  <Loader2 size={14} class="verevon-trust-spin" aria-hidden="true" /> {i18n.tr('Sletter…', 'Erasing…')}
                </Show>
              </SettingsButton>
            </div>
          </form>
