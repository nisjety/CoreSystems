...
export default function AccountSettingsPage() {
  ...
  const actionDescription = createMemo(() => {
    ...
    return i18n.tr('Din personlige profil og dine innstillinger lagres på Verevon-kontoen din.', 'Your personal profile and preferences are saved to your Verevon account.')
  })
  ...
  return (
    ...
    >
      ...
      <Show when={missingProfileFields().length > 0}>
        <p class="verevon-settings-status-message" role="status">
          {i18n.tr('Leverandørdata er brukt der tilgjengelig. Legg til', 'Provider data has been applied where available. Add')} {missingProfileFields().join(', ')} {i18n.tr('for å fullføre Verevon-profilen.', 'to complete the Verevon profile.')}
        </p>
      </Show>
      <ProfileSection
        form={form}
...
function ProfileSection(props: {
  ...
  return (
    <section id="profile" class="verevon-settings-section">
      <SectionHeader
        title={i18n.tr('Profil', 'Profile')}
        description={i18n.tr('Bestem hvordan kollegaer og kunder ser deg på tvers av Verevon.', 'Control how teammates and customers see you across Verevon.')}
      />

      <div class="verevon-settings-avatar-row">
        <button
          type="button"
          aria-label={i18n.tr('Profilbilde', 'Profile avatar')}
          class="verevon-settings-avatar"
          disabled
        >
...
function ContactSection(props: {
  ...
  return (
    <section id="contact" class="verevon-settings-section">
      <SectionHeader
...
function PreferencesSection(props: {
  ...
  const i18n = useI18n()
  return (
    <section id="preferences" class="verevon-settings-section">
      <SectionHeader
        title={i18n.tr('Innstillinger', 'Preferences')}
        description={i18n.tr('Tilpass hvordan Verevon formaterer språk, utseende og kollegers navn.', 'Personalize how Verevon formats language, appearance, and teammate names.')}
      />
      <div class="verevon-settings-field-grid">
        <SettingsSelect
          id="language"
...
function AvailabilitySection(props: {
  ...
  return (
    <section id="availability" class="verevon-settings-section">
      <SectionHeader
...
function ConnectedAccountsSection(props: {
  ...
  return (
    <section id="connected-accounts" class="verevon-settings-section">
      <SectionHeader
        title={i18n.tr('Tilkoblede kontoer', 'Connected accounts')}
        description={i18n.tr('Innloggingsleverandører konfigurert for denne Verevon-kontoen.', 'Sign-in providers configured for this Verevon account.')}
      />
...
function PrivacySection() {
  const i18n = useI18n()
  return (
    <section id="privacy" class="verevon-settings-section">
      <SectionHeader
