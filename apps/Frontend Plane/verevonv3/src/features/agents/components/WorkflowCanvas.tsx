...
export function WorkflowPromptComposer() {
  ...
  return (
    ...
    >
      ...
      />
      <VerevonIconButton type="button" size="sm" shape="circle" aria-label={i18n.tr('Utvid komponisten', 'Expand composer')} disabled class="shrink-0">
        <Maximize2 class="size-3.5" strokeWidth={2} />
      </VerevonIconButton>
      <VerevonIconButton type="button" size="sm" shape="circle" aria-label={i18n.tr('Dikter arbeidsflyt-prompt', 'Dictate workflow prompt')} disabled class="shrink-0">
