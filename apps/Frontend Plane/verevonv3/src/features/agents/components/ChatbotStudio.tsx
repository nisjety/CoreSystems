...
import {
  ...
  studioSections,
} from '@/features/agents/lib/verevon-chatbot-studio-data'
  ...
  return (
    <section class="mx-auto max-w-[1280px] px-6 py-7">
      ...
      <EmptyStateCard
        ...
        description={i18n.tr(
          'Verevon vil rangere ubesvarte spørsmål, manglende kilder og mislykkede handlinger når det kommer inn ekte samtaler.',
          'Verevon will rank unanswered questions, missing sources, and action failures after live conversations arrive.',
        )}
      />
...
function TopicsPanel() {
  ...
  return (
    <div class="verevon-panel mt-7 p-6">
  ...
  return (
    <section class="grid min-h-full gap-8 px-7 py-8 xl:grid-cols-[minmax(0,1fr)_420px]">
      <div class="min-w-0">
        ...
        <div class="verevon-panel mt-12 p-7">
      ...
      <aside class="border-l border-[#E3E4E8] bg-[#F7F7F8] p-8 dark:border-[#2A2C31] dark:bg-[#111216] xl:-my-8 xl:-mr-7">
        ...
        <div class="verevon-panel mt-8 p-5">
        ...
        <div class="verevon-panel mt-6 p-5">
...
function InstallPage() {
  ...
  const channels: Array<{ title: string; badge?: string; description: string; Icon: StudioIcon; action: string }> = [
    ...
    {
      title: 'WordPress',
      description: i18n.tr('Installer Verevon-widgetskriptet gjennom en WordPress-embed eller plugin-wrapper.', 'Install the Verevon widget script through a WordPress embed or plugin wrapper.'),
      Icon: Globe2,
      ...
      <aside class="border-r border-[#E3E4E8] bg-white px-6 py-8 dark:border-[#2A2C31] dark:bg-[#101114]">
        <div class="flex items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <VerevonIconButton size="lg" shape="rounded" tone="primary" disabled aria-label={i18n.tr('Last ned chattelogger', 'Download chat logs')}>
  ...
  return (
    <section class="mx-auto max-w-[980px] px-7 py-8">
      ...
      <div class="mt-10 grid gap-5">
        <For each={settings}>
          {(setting) => (
            <label class="verevon-panel grid gap-3 p-5">
              <span class="text-[14px] font-semibold text-[#6F747D] dark:text-[#AEB4C0]">{setting[0]}</span>
              <VerevonInput value={setting[1]} class="px-4 text-[13px]" />
            </label>
          )}
        </For>
      </div>
