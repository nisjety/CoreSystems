...
const variantClasses = {
	dark: "text-verevon-j-text",
	light: "text-verevon-c-white",
	muted: "text-verevon-j-text/60",
	coral: "text-verevon-coral",
};
...
export function ArrowButton(props: ArrowButtonProps) {
	...
	if ("href" in props && props.href) {
		...
		if (href.startsWith("/") && !href.startsWith("//")) {
			return (
				<Link {...linkProps} className={wrapperClasses} href={href}>
					{content}
				</Link>
			);
		}
