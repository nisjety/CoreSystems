...
/**
 * StatusBadge — the honesty primitive for Verevon's trust surfaces.
 *
 * Verevon holds the controls but not (yet) the third-party certifications.
...
const STATUS_STYLE: Record<StatusLevel, CSSProperties> = {
	live: {
		color: "var(--verevon-status-live)",
		background: "var(--verevon-status-live-soft)",
	},
	progress: {
		color: "var(--verevon-coral-deep)",
		background: "var(--verevon-status-progress-soft)",
	},
	planned: {
		color: "var(--verevon-status-planned)",
		background: "var(--verevon-status-planned-soft)",
	},
};

const DOT_COLOR: Record<StatusLevel, string> = {
	live: "var(--verevon-status-live)",
	progress: "var(--verevon-status-progress)",
	planned: "var(--verevon-status-planned)",
};
