...
import styles from "./VerevonShortShowcase.module.css";
...
type VerevonShortShowcaseStageProps = {
	ariaLabel?: string;
	className?: string;
	variant?: "standalone" | "embedded" | "viewport";
};

export function VerevonShortShowcaseStage({
	ariaLabel = "Verevon vertical product animation for short-form recording",
	className = "",
	variant = "standalone",
}: VerevonShortShowcaseStageProps) {
			...
			<div className={styles.browserFrame} data-browser="">
				<div className={styles.browserChrome}>
					<div className={styles.brandLockup}>
						<span className={styles.brandWord}>VEREVON</span>
				...
				<div className={styles.browserViewport}>
					...
					<div className={styles.finalCopy} data-final-copy="">
						...
						<p>
							Verevon keeps signals, reviewers, and source evidence moving
							together.
						</p>
...
export function VerevonShortShowcase() {
	return (
