...
const variantBackgrounds: Record<VisualPanelVariant, string> = {
	...
	surface:
		"bg-[linear-gradient(135deg,#171717,var(--verevon-h-teal-deep))] text-verevon-c-white",
	mark:
...
function getVariantTone(variant: VisualPanelVariant) {
	if (variant === "surface") {
		return {
			line: "bg-verevon-c-white/25",
			node:
				"border-verevon-c-white/40 bg-verevon-c-white/80 shadow-[0_0_0_6px_rgba(247,244,238,0.16)]",
			panel: "border-verevon-c-white/20 bg-verevon-c-white/10",
			card: "border-verevon-c-white/20 bg-verevon-c-white/10",
		};
	}

	return {
		line: "bg-verevon-j-text/15",
		node:
			"border-verevon-j-text/25 bg-background shadow-[0_0_0_6px_rgba(248,248,247,0.64)]",
		panel: "border-verevon-j-text/10 bg-white/45",
		card: "border-verevon-j-text/12 bg-white/20",
	};
}
		...
		>
			...
			<span
				...
				className={[
					...
					variant === "surface"
						? tone.node
						: "border-verevon-a-earth/40 bg-background shadow-[0_0_0_6px_rgba(248,248,247,0.64)]",
				].join(" ")}
			/>
