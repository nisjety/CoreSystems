# Verevon sub-pages — innhold, produktbevis og lanseringskrav

**Status:** Strategisk spesifikasjon for offentlig nettsted og produktflater.
**Grunnlag:** Konkurrentanalyse, nåværende Verevon-hjemmeside og CoreSystem-dokumentasjon.
**Viktig dato:** Statusdokumentene med siste verifisering 13. juli 2026 overstyrer eldre, mer optimistiske produktbeskrivelser.

## Hensikt

Dette dokumentet skal styre hvilke undersider Verevon trenger, hva de skal si, og hva som faktisk må fungere før en offentlig lansering. Det er ikke en plan for å fylle nettstedet med funksjonssider. Hver side skal bevise én konkret verdi som allerede er synlig i produktet.

Den sentrale fortellingen er:

> **Du trenger ikke å bytte ut verdenen din for å bruke Verevon. Verevon samler konteksten rundt arbeidet, foreslår neste steg og utfører bare det dere har gitt den lov til.**

Verevon må ikke posisjoneres som «en helpdesk med AI» eller «en chatbot-bygger». Det riktige produktløftet er:
...
2. Verevon samler relevant kontekst og viser kildene.
3. Verevon foreslår eller forbereder en handling.
...
Verevon skal ikke lansere en funksjonsside, logo, produktvideo eller påstand som ikke har et reelt, verifisert produktbevis bak seg. En attraktiv mockup kan forklare arbeidsflyten, men kan ikke stå inn for en ikke-utplassert sikkerhets-, personvern- eller kontrollmekanisme.
...
Historiske «live»-påstander i [VEREVON.md](../../../../../VEREVON.md) er eksplisitt ikke en nåværende lanseringssertifisering. Bruk dokumentet til produktretning og begreper, ikke som eneste bevis for offentlig copy.

### Hva Verevon må eie språklig

| Ikke dette | Dette |
| --- | --- |
| «Erstatt alle systemene deres» | «Få mer ut av systemene dere allerede bruker» |
| «AI svarer automatisk» | «Verevon forbereder, begrunner og handler innenfor rammene dere setter» |
...
| --- | --- | --- | --- |
| Hero | «Fra signal til handling.» og «Kilder, svar og godkjenning i én arbeidsflyt.» | Setter Verevon opp som et arbeidslag, ikke bare en chat. | Hva et signal er, hvilke systemer som kan gi kontekst, og hva kontroll betyr. |
...
| Problemet | «Alle kan koble på en språkmodell. Færre kan vise kilden, la et menneske si ja — og likevel handle i tide.» | Gir Verevon et tydeligere problem enn «AI er vanskelig». | Må lede videre til kontrollert arbeid og tillit, ikke en generell AI-side. |
| Funksjonskort | «Tenking, satt i arbeid» med Signal → Kontekst → Forslag → Godkjenning og kortene Bygg, Koble, Forstå, Deleger. | Er den tydeligste forklaringen på Verevons operativmodell. | Hvert kort trenger en faktisk produktside med konkret flyt og bevis. |
| Senses | «Dere trenger ikke å bytte ut verden deres for å bruke Verevon.» | Leverer resultatet av produktet: felles kontekst, forklaring og menneskelig kontroll. | Må bli hovedinngangen til Felles kontekst, Kontrollert arbeid og Tillit. |
...
- Den aktive hjemmesiden monterer Hero, koblingslisten, Problem, Feature Cards, Senses, Layer og avslutningen i [VerevonHome.tsx](src/components/home/VerevonHome.tsx).
- [ProductLoopSection.tsx](src/components/home/sections/ProductLoopSection.tsx) finnes med en god produktfortelling — Spør → Utkast → Godkjenn → Revider — men den er **ikke montert i den aktive VerevonHome** nå.
...
- Hjemmesiden har allerede språk for kilde, policy, godkjenning, revisjon og tilbakerulling. Det er Verevons mest differensierende språk og må ikke erstattes med vage ord som «smartere AI».

## Hjemmesidens viktigste styrker

1. Den viser en kontrollert arbeidsflyt i stedet for en isolert AI-chat.
2. Den bruker kjente systemer som overgang fra dagens arbeid til Verevon.
...
| Gjentatt budskap | Hvordan det selges | Hva Verevon skal gjøre bedre |
| --- | --- | --- |
| Ingen smertefull migrering | «Koble til innboks, CRM, kalender eller dokumenter.» | Si tydelig at Verevon blir en partner rundt dagens arbeid, ikke en ny silo. |
...
- **Wonderful** er best på enterprise-rammen: bygg, distribuer, overvåk og forbedre agenter i kontrollerte flater. Verevon skal ta med kontroll, roller, spor og evaluering — men beholde et enklere, mer konkret arbeidsutgangspunkt.
- **Ayfie** er best på virksomhetskontekst og kildebevis: data blir i kildesystemene, og svaret er koblet til det som faktisk ble funnet. Verevon skal gjøre dette operativt: kontekst skal kunne bli et forslag og en kontrollert handling.
- **Taito** er best på adopsjon gjennom hverdagen: teamet fortsetter i Slack, dokumenter og arbeidsflyter de kjenner. Verevon skal adoptere dette språket: «arbeidet fortsetter, men med mindre leting».
- **Peec** er best på sekvens: signal → data → kilde → innsikt → handling. Verevon skal bruke samme tydelighet for interne og kundevendte arbeidsflyter.
- **Attio** er best på kontekst som kontinuerlig oppdatert atferd: e-post, samtaler og data blir neste steg. Verevon skal legge til sporbarhet og eksplisitt godkjenning.
- **Intercom og Fin** er best på tydelig kundearbeid: alle kanaler, én operatorflate, godkjenninger og pålitelige svar. Verevon skal ikke prøve å late som om alt innen kanaler er ferdig før runtime er ferdig.
...
| Kjerne | /plattform/felles-kontekst | Vis at Verevon samler historikk, kunnskap og neste steg uten å erstatte arbeidsverdenen. |
...
| Kjerne | /løsninger/overvåking-og-innsikt | Vis hvordan Verevon oppdager endring, knytter den til kilder og foreslår neste steg. |
| Kjerne | /integrasjoner | Vis hva Verevon kobles til, hva som synkroniseres, og nøyaktig tilgang/status. |
...
Gjøre Verevons modell forståelig på under et minutt:

> **Et signal blir til en kontrollert handling.**

Siden skal bygge videre på produktløkken, ikke gjenta Feature Cards. Feature Cards forklarer **hva Verevon kan gjøre**. Denne siden viser **hvordan én oppgave faktisk beveger seg gjennom systemet**.
...
- «Spør på vanlig språk. Verevon samler det som er relevant før den foreslår noe.»
...
Gi brukeren følelsen av at Verevon **ikke ber dem om å starte på nytt**.

Hovedbudskap:

> **Felles kontekst, før neste overlevering.**
> Verevon samler historikken, kunnskapen og det som må skje videre.
...
4. Vis «hva Verevon vet nå», «hva den fortsatt mangler» og «hva som bør skje videre».
...
- «Verevon samler det dere allerede har — og gjør mangler synlige.»
...
Bevise at Verevon er et kontrollert arbeidslag, ikke en svart boks.
...
5. En egen del om grenser: hvilke handlinger Verevon ikke kan gjøre uten tillatelse.
...
- «Verevon kan forberede arbeidet. Det kan ikke utvide sine egne rammer.»
...
Forklare hvordan Verevon hjelper teamet med kundesamtaler, innboksarbeid, oppfølging og overleveringer — uten å kreve at leseren allerede kjenner ord som «helpdesk», «ticket» eller «chatbot».

Hovedbudskap:

> **Hver kunde trenger riktig svar. Verevon gjør svaret klart.**
...
5. Vis hva som skjer når Verevon er usikker: den eskalerer eller ber om avklaring.
...
- «Verevon gjør ikke kundearbeidet mindre menneskelig. Det fjerner letingen rundt det.»
...
Vise at Verevon ikke bare reagerer på en samtale som allerede har kommet inn. Det kan følge med på kilder, endringer, markedssignaler og virksomhetsinformasjon — og levere et begrunnet neste steg.
...
- «Verevon peker på hva som har endret seg. Dere bestemmer om det skal bli til arbeid.»
...
> **Nei. Verevon begynner med systemene dere allerede bruker, og dere ser hva den får lese eller gjøre i hvert enkelt tilfelle.**

### Foreslått innhold

1. En enkel logooversikt med kun reelle, tilgjengelige eller presist merket koblinger.
2. For hver kobling:
   - hva Verevon kan hente
   - hva Verevon kan foreslå
   - hva Verevon eventuelt kan gjøre
...
- «Verevon møter dere der arbeidet allerede skjer.»
- «Koble til det som gir kontekst. Velg selv hva Verevon får se og gjøre.»
...
> **Dere skal kunne se hva Verevon bruker, hva den får gjøre og hva som faktisk skjedde.**
...
- «Verevon skal ikke gjøre kontrollen usynlig når arbeidet blir raskere.»
...
Vise hvordan et team former Verevon for sin måte å arbeide på — uten å late som om en tilfeldig prompt er produksjonsklar automatisering.

Hovedbudskap:

> **Bygg Verevon rundt arbeidet deres, og test rammene før den får ansvar.**

Denne siden passer kortet **Bygg Verevon**. Den skal samle agentoppsett, chatbot-oppsett, regler, tone, modellvalg, kilder, testeksempler og godkjenningsnivåer.
...
- «Form Verevon for dere, uten å miste innsikten i hva den gjør.»
...
Gi tekniske kjøpere og integrasjonspartnere et sted å forstå hvordan Verevon kan kobles til egne systemer — men bare når autorisasjon, tenantgrenser, audit og runtime faktisk er klar.

Hovedbudskap:

> **Koble Verevon til arbeidet deres med de samme grensene som gjelder i produktet.**
...
Wonderful, Fin og Taito viser at vertikale sider kan gjøre et komplekst produkt enkelt å forstå. Verevon bør ikke starte med seks bransjesider som lover mer enn produktet beviser. Første fase bør være to modulære templates:
...
# 5. Hva Verevon må bygge og bevise før offentlig lansering
...
- Verevon kan hente riktig kontekst fra autoriserte kilder.
...
- [Verevon product and reality record](../../../../../VEREVON.md)
...
2. Forklare Verevons arbeidsflyt.
...
- «Se hva Verevon bruker»
- «Se kontrollene»
- «Se systemene dere kan koble til»
- «Se hvordan dere former Verevon»
...
Disse sidene var del av den bredere referanserammen for Verevon, men ikke av den detaljerte undersiderevisjonen over. De er beholdt for sammenligning når nye undersider skrives:
...
Verevon har allerede den riktige overordnede fortellingen på hjemmesiden:

> **Problem:** Det holder ikke at AI svarer; arbeidet må kunne forstås og kontrolleres.
> **Løsning:** Verevon samler kontekst, lager forslag og arbeider innenfor tydelige rammer.
