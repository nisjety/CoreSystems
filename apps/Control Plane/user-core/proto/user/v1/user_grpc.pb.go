...
const (
	DocumentAccessService_GrantDocumentAccess_FullMethodName  = "/user.v1.DocumentAccessService/GrantDocumentAccess"
	DocumentAccessService_RevokeDocumentAccess_FullMethodName = "/user.v1.DocumentAccessService/RevokeDocumentAccess"
	DocumentAccessService_GetDocumentAccess_FullMethodName    = "/user.v1.DocumentAccessService/GetDocumentAccess"
	DocumentAccessService_ListDocumentAccess_FullMethodName   = "/user.v1.DocumentAccessService/ListDocumentAccess"
	DocumentAccessService_CheckDocumentAccess_FullMethodName  = "/user.v1.DocumentAccessService/CheckDocumentAccess"
)

// DocumentAccessServiceClient is the client API for DocumentAccessService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type DocumentAccessServiceClient interface {
	GrantDocumentAccess(ctx context.Context, in *GrantDocumentAccessRequest, opts ...grpc.CallOption) (*GrantDocumentAccessResponse, error)
	...
	CheckDocumentAccess(ctx context.Context, in *CheckDocumentAccessRequest, opts ...grpc.CallOption) (*CheckDocumentAccessResponse, error)
}
...
func NewDocumentAccessServiceClient(cc grpc.ClientConnInterface) DocumentAccessServiceClient {
	return &documentAccessServiceClient{cc}
}

func (c *documentAccessServiceClient) GrantDocumentAccess(ctx context.Context, in *GrantDocumentAccessRequest, opts ...grpc.CallOption) (*GrantDocumentAccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GrantDocumentAccessResponse)
	err := c.cc.Invoke(ctx, DocumentAccessService_GrantDocumentAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentAccessServiceClient) RevokeDocumentAccess(ctx context.Context, in *RevokeDocumentAccessRequest, opts ...grpc.CallOption) (*RevokeDocumentAccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RevokeDocumentAccessResponse)
	err := c.cc.Invoke(ctx, DocumentAccessService_RevokeDocumentAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentAccessServiceClient) GetDocumentAccess(ctx context.Context, in *GetDocumentAccessRequest, opts ...grpc.CallOption) (*GetDocumentAccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDocumentAccessResponse)
	err := c.cc.Invoke(ctx, DocumentAccessService_GetDocumentAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentAccessServiceClient) ListDocumentAccess(ctx context.Context, in *ListDocumentAccessRequest, opts ...grpc.CallOption) (*ListDocumentAccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListDocumentAccessResponse)
	err := c.cc.Invoke(ctx, DocumentAccessService_ListDocumentAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentAccessServiceClient) CheckDocumentAccess(ctx context.Context, in *CheckDocumentAccessRequest, opts ...grpc.CallOption) (*CheckDocumentAccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckDocumentAccessResponse)
	err := c.cc.Invoke(ctx, DocumentAccessService_CheckDocumentAccess_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// DocumentAccessServiceServer is the server API for DocumentAccessService service.
// All implementations must embed UnimplementedDocumentAccessServiceServer
// for forward compatibility.
type DocumentAccessServiceServer interface {
	GrantDocumentAccess(context.Context, *GrantDocumentAccessRequest) (*GrantDocumentAccessResponse, error)
	...
	CheckDocumentAccess(context.Context, *CheckDocumentAccessRequest) (*CheckDocumentAccessResponse, error)
	mustEmbedUnimplementedDocumentAccessServiceServer()
}

// UnimplementedDocumentAccessServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedDocumentAccessServiceServer struct{}

func (UnimplementedDocumentAccessServiceServer) GrantDocumentAccess(context.Context, *GrantDocumentAccessRequest) (*GrantDocumentAccessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GrantDocumentAccess not implemented")
}
func (UnimplementedDocumentAccessServiceServer) RevokeDocumentAccess(context.Context, *RevokeDocumentAccessRequest) (*RevokeDocumentAccessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RevokeDocumentAccess not implemented")
}
func (UnimplementedDocumentAccessServiceServer) GetDocumentAccess(context.Context, *GetDocumentAccessRequest) (*GetDocumentAccessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetDocumentAccess not implemented")
}
func (UnimplementedDocumentAccessServiceServer) ListDocumentAccess(context.Context, *ListDocumentAccessRequest) (*ListDocumentAccessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListDocumentAccess not implemented")
}
func (UnimplementedDocumentAccessServiceServer) CheckDocumentAccess(context.Context, *CheckDocumentAccessRequest) (*CheckDocumentAccessResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CheckDocumentAccess not implemented")
}
func (UnimplementedDocumentAccessServiceServer) mustEmbedUnimplementedDocumentAccessServiceServer() {}
func (UnimplementedDocumentAccessServiceServer) testEmbeddedByValue()                               {}

// UnsafeDocumentAccessServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to DocumentAccessServiceServer will
// result in compilation errors.
type UnsafeDocumentAccessServiceServer interface {
	mustEmbedUnimplementedDocumentAccessServiceServer()
}

func RegisterDocumentAccessServiceServer(s grpc.ServiceRegistrar, srv DocumentAccessServiceServer) {
	// If the following call panics, it indicates UnimplementedDocumentAccessServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&DocumentAccessService_ServiceDesc, srv)
}

func _DocumentAccessService_GrantDocumentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GrantDocumentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentAccessServiceServer).GrantDocumentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocumentAccessService_GrantDocumentAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentAccessServiceServer).GrantDocumentAccess(ctx, req.(*GrantDocumentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DocumentAccessService_RevokeDocumentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeDocumentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentAccessServiceServer).RevokeDocumentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocumentAccessService_RevokeDocumentAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentAccessServiceServer).RevokeDocumentAccess(ctx, req.(*RevokeDocumentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DocumentAccessService_GetDocumentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDocumentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentAccessServiceServer).GetDocumentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocumentAccessService_GetDocumentAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentAccessServiceServer).GetDocumentAccess(ctx, req.(*GetDocumentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DocumentAccessService_ListDocumentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDocumentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentAccessServiceServer).ListDocumentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocumentAccessService_ListDocumentAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentAccessServiceServer).ListDocumentAccess(ctx, req.(*ListDocumentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DocumentAccessService_CheckDocumentAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckDocumentAccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DocumentAccessServiceServer).CheckDocumentAccess(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DocumentAccessService_CheckDocumentAccess_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DocumentAccessServiceServer).CheckDocumentAccess(ctx, req.(*CheckDocumentAccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// DocumentAccessService_ServiceDesc is the grpc.ServiceDesc for DocumentAccessService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var DocumentAccessService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.v1.DocumentAccessService",
	HandlerType: (*DocumentAccessServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GrantDocumentAccess",
			Handler:    _DocumentAccessService_GrantDocumentAccess_Handler,
		},
		{
			MethodName: "RevokeDocumentAccess",
			Handler:    _DocumentAccessService_RevokeDocumentAccess_Handler,
		},
		{
			MethodName: "GetDocumentAccess",
			Handler:    _DocumentAccessService_GetDocumentAccess_Handler,
		},
		{
			MethodName: "ListDocumentAccess",
			Handler:    _DocumentAccessService_ListDocumentAccess_Handler,
		},
		{
			MethodName: "CheckDocumentAccess",
			Handler:    _DocumentAccessService_CheckDocumentAccess_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/user/v1/user.proto",
