...
// setVisibleDelegationContext pins the verified "authz:visible" delegation
// tuple shared by the delegation middleware tests.
func setVisibleDelegationContext(c *gin.Context) {
	c.Set("auth_method", "service_principal")
	c.Set("delegation_verified", true)
