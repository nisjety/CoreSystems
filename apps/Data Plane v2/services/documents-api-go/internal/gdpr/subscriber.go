...
//
// user-core publishes `verevon.gdpr.erasure.requested` on the shared bus when a
...
// `verevon.gdpr.ownership.transferred`. It is idempotent and best-effort.
//
...
const (
	...
	ErasureRequestedSubject = "verevon.gdpr.erasure.requested"
	// OwnershipTransferredSubject is emitted after a successful transfer.
	OwnershipTransferredSubject = "verevon.gdpr.ownership.transferred"
