...
func TestVerifierAcceptsBoundDelegationAndRejectsReplay(t *testing.T) {
	...
	if principal.ServiceID != "verevon-gateway" || principal.UserID != "user-1" || principal.OrganizationID != "org-1" || principal.Role != "member" {
...
func TestVerifierConfigurationAndContextFailClosed(t *testing.T) {
	...
	principal := Principal{ServiceID: "verevon-gateway", OrganizationID: "org-1"}
