...
| MP-016 | High | Visma may be falsely presented as a Velion capability | MCP/product owner | Reject malformed records; show `not_configured`; onboard a real governed server | Schema/discovery/auth/HITL E2E | not configured | No live bridge/server |
