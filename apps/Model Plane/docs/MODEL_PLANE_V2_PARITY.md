...
| Speech TTS/STT/stream/detect/list voices | Partial | `InferenceCore.SynthesizeSpeech`, `TranscribeSpeech`, `ListSpeechVoices`; `/v1/ai/speech`, `/v1/ai/speech/voices`; OpenAI, Azure OpenAI, Azure Speech TTS | Add streaming transcription, spoken-language detection, and realtime voice session ownership. |
