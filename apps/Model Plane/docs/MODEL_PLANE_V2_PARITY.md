...
- Planned Verevon Voice retention modes: `cloud_zdr` for high-quality approved cloud STT/LLM processing, `company_private` for lower-quality self-hosted STT where raw audio/transcripts do not leave customer-controlled infrastructure, and explicit-save-only Teams transcript summarization.
