...
func TestAuthorizeHTTPPinsTenantAndRequiresWriteScope(t *testing.T) {
	...
	healthWriter := authctx.Principal{OrganizationID: "org-a", ActorID: "health-a", PrincipalType: "service", Scopes: []string{HealthWriteScope}}
...
func TestAuthorizeGRPCPinsEvaluatePolicyAndProtectsPromotion(t *testing.T) {
	...
	globalWriter := authctx.Principal{OrganizationID: "org-a", ActorID: "svc-admin", PrincipalType: "service", Scopes: []string{"capability:global:write"}}
