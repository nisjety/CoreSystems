...
func customsDocument(rec Record, booked carrier.Booking) []byte {
	...
	lines = append(lines, docgen.Txt("Generated by Verevon shipping-core "+time.Now().UTC().Format(time.RFC3339)))
...
func manifestDocument(carrierCode string, included []Record) []byte {
	...
	lines = append(lines, docgen.Txt(""), docgen.Txt("Generated by Verevon shipping-core."))
	return docgen.PDF(docgen.PageA4, lines)
}
