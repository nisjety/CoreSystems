...
use quarry_core::contracts::{
    ...
    DataPlaneIngestRequest, DataPlaneIngestResponse, DomSummary, EmbeddingStatus,
    ExtractionUsage, IndexStatus, InteractiveElement, SourceTrace, StructuredExtractRequest,
...
fn agent_action_all_variants_serialize() {
    let actions = vec![
        AgentAction::Navigate { url: "https://x.com".into() },
        AgentAction::Click { selector: "#a".into() },
        AgentAction::Type { selector: "#i".into(), text: "hi".into() },
        AgentAction::Press { key: "Enter".into() },
        AgentAction::Scroll { target: "#footer".into() },
        AgentAction::Select { selector: "select".into(), value: "opt1".into() },
        AgentAction::Wait { ms: 100 },
        AgentAction::WaitFor { selector: ".done".into(), timeout_ms: 5000 },
        AgentAction::Screenshot { full_page: true },
        AgentAction::Pdf,
        AgentAction::Evaluate { script: "1+1".into() },
        AgentAction::Back,
