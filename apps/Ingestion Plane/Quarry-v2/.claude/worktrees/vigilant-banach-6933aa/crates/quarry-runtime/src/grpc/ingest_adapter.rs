...
use crate::ingest_client::{DataPlaneIngest, IngestClient};
...
mod tests {
    ...
    fn zdr_on_maps_to_ephemeral_classification() {
        assert_eq!(GrpcIngestAdapter::zdr_classification(ZdrMode::On), "ephemeral");
        assert_eq!(GrpcIngestAdapter::zdr_classification(ZdrMode::Off), "standard");
    }
