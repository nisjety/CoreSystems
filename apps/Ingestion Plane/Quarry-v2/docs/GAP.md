...
| 17 | Browser path SSRF via chromiumoxide (DnsGuard not called) | Closed — DnsGuard preflight wired into `ChromiumoxideDriver::goto()`; SSRF tests in `crates/quarry-browser/tests/ssrf.rs` | Done | Done 2026-05-05 |
