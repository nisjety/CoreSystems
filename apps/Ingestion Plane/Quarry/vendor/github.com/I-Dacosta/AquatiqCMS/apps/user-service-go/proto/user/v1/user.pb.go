...
const file_proto_user_v1_user_proto_rawDesc = "" +
	...
	"\x06avatar\x18\x04 \x01(\tR\x06avatar\"7\n" +
	...
	"\x0fSERVICE_UNKNOWN\x10\x03*\x8f\x01\n" +
	"\n" +
	"UserStatus\x12\x1b\n" +
	...
	"\vHealthCheck\x12\x1b.user.v1.HealthCheckRequest\x1a\x1c.user.v1.HealthCheckResponseBKZIgithub.com/I-Dacosta/AquatiqCMS/apps/user-service-go/proto/user/v1;userv1b\x06proto3"
...
var file_proto_user_v1_user_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
...
var file_proto_user_v1_user_proto_depIdxs = []int32{
	...
	65, // 1: user.v1.User.created_at:type_name -> google.protobuf.Timestamp
	65, // 2: user.v1.User.updated_at:type_name -> google.protobuf.Timestamp
	65, // 3: user.v1.User.last_login_at:type_name -> google.protobuf.Timestamp
	66, // 4: user.v1.UserProfile.metadata:type_name -> google.protobuf.Struct
	65, // 5: user.v1.UserProfile.updated_at:type_name -> google.protobuf.Timestamp
	65, // 6: user.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	65, // 7: user.v1.Session.expires_at:type_name -> google.protobuf.Timestamp
	65, // 8: user.v1.Session.last_accessed_at:type_name -> google.protobuf.Timestamp
	66, // 9: user.v1.Activity.details:type_name -> google.protobuf.Struct
	65, // 10: user.v1.Activity.created_at:type_name -> google.protobuf.Timestamp
	65, // 11: user.v1.Device.last_used_at:type_name -> google.protobuf.Timestamp
	65, // 12: user.v1.Device.created_at:type_name -> google.protobuf.Timestamp
	...
	65, // 24: user.v1.SuspendUserRequest.until:type_name -> google.protobuf.Timestamp
	...
	66, // 28: user.v1.UpdateUserProfileRequest.metadata:type_name -> google.protobuf.Struct
	...
	66, // 32: user.v1.LogActivityRequest.details:type_name -> google.protobuf.Struct
	...
	9,  // 41: user.v1.UserService.CreateUser:input_type -> user.v1.CreateUserRequest
	11, // 42: user.v1.UserService.GetUser:input_type -> user.v1.GetUserRequest
	13, // 43: user.v1.UserService.GetUserByEmail:input_type -> user.v1.GetUserByEmailRequest
	15, // 44: user.v1.UserService.UpdateUser:input_type -> user.v1.UpdateUserRequest
	17, // 45: user.v1.UserService.DeleteUser:input_type -> user.v1.DeleteUserRequest
	19, // 46: user.v1.UserService.ListUsers:input_type -> user.v1.ListUsersRequest
	21, // 47: user.v1.UserService.ActivateUser:input_type -> user.v1.ActivateUserRequest
	23, // 48: user.v1.UserService.DeactivateUser:input_type -> user.v1.DeactivateUserRequest
	25, // 49: user.v1.UserService.BlockUser:input_type -> user.v1.BlockUserRequest
	27, // 50: user.v1.UserService.UnblockUser:input_type -> user.v1.UnblockUserRequest
	29, // 51: user.v1.UserService.SuspendUser:input_type -> user.v1.SuspendUserRequest
	31, // 52: user.v1.UserService.UnsuspendUser:input_type -> user.v1.UnsuspendUserRequest
	33, // 53: user.v1.UserService.GetUserProfile:input_type -> user.v1.GetUserProfileRequest
	35, // 54: user.v1.UserService.UpdateUserProfile:input_type -> user.v1.UpdateUserProfileRequest
	37, // 55: user.v1.UserService.CreateSession:input_type -> user.v1.CreateSessionRequest
	39, // 56: user.v1.UserService.ListSessions:input_type -> user.v1.ListSessionsRequest
	41, // 57: user.v1.UserService.InvalidateSession:input_type -> user.v1.InvalidateSessionRequest
	43, // 58: user.v1.UserService.InvalidateAllSessions:input_type -> user.v1.InvalidateAllSessionsRequest
	45, // 59: user.v1.UserService.LogActivity:input_type -> user.v1.LogActivityRequest
	47, // 60: user.v1.UserService.ListActivities:input_type -> user.v1.ListActivitiesRequest
	49, // 61: user.v1.UserService.AssignRole:input_type -> user.v1.AssignRoleRequest
	51, // 62: user.v1.UserService.ListUserRoles:input_type -> user.v1.ListUserRolesRequest
	53, // 63: user.v1.UserService.RemoveRole:input_type -> user.v1.RemoveRoleRequest
	55, // 64: user.v1.UserService.RegisterDevice:input_type -> user.v1.RegisterDeviceRequest
	57, // 65: user.v1.UserService.ListDevices:input_type -> user.v1.ListDevicesRequest
	59, // 66: user.v1.UserService.UpdateDevice:input_type -> user.v1.UpdateDeviceRequest
	61, // 67: user.v1.UserService.DeactivateDevice:input_type -> user.v1.DeactivateDeviceRequest
	63, // 68: user.v1.UserService.HealthCheck:input_type -> user.v1.HealthCheckRequest
	10, // 69: user.v1.UserService.CreateUser:output_type -> user.v1.CreateUserResponse
	12, // 70: user.v1.UserService.GetUser:output_type -> user.v1.GetUserResponse
	14, // 71: user.v1.UserService.GetUserByEmail:output_type -> user.v1.GetUserByEmailResponse
	16, // 72: user.v1.UserService.UpdateUser:output_type -> user.v1.UpdateUserResponse
	18, // 73: user.v1.UserService.DeleteUser:output_type -> user.v1.DeleteUserResponse
	20, // 74: user.v1.UserService.ListUsers:output_type -> user.v1.ListUsersResponse
	22, // 75: user.v1.UserService.ActivateUser:output_type -> user.v1.ActivateUserResponse
	24, // 76: user.v1.UserService.DeactivateUser:output_type -> user.v1.DeactivateUserResponse
	26, // 77: user.v1.UserService.BlockUser:output_type -> user.v1.BlockUserResponse
	28, // 78: user.v1.UserService.UnblockUser:output_type -> user.v1.UnblockUserResponse
	30, // 79: user.v1.UserService.SuspendUser:output_type -> user.v1.SuspendUserResponse
	32, // 80: user.v1.UserService.UnsuspendUser:output_type -> user.v1.UnsuspendUserResponse
	34, // 81: user.v1.UserService.GetUserProfile:output_type -> user.v1.GetUserProfileResponse
	36, // 82: user.v1.UserService.UpdateUserProfile:output_type -> user.v1.UpdateUserProfileResponse
	38, // 83: user.v1.UserService.CreateSession:output_type -> user.v1.CreateSessionResponse
	40, // 84: user.v1.UserService.ListSessions:output_type -> user.v1.ListSessionsResponse
	42, // 85: user.v1.UserService.InvalidateSession:output_type -> user.v1.InvalidateSessionResponse
	44, // 86: user.v1.UserService.InvalidateAllSessions:output_type -> user.v1.InvalidateAllSessionsResponse
	46, // 87: user.v1.UserService.LogActivity:output_type -> user.v1.LogActivityResponse
	48, // 88: user.v1.UserService.ListActivities:output_type -> user.v1.ListActivitiesResponse
	50, // 89: user.v1.UserService.AssignRole:output_type -> user.v1.AssignRoleResponse
	52, // 90: user.v1.UserService.ListUserRoles:output_type -> user.v1.ListUserRolesResponse
	54, // 91: user.v1.UserService.RemoveRole:output_type -> user.v1.RemoveRoleResponse
	56, // 92: user.v1.UserService.RegisterDevice:output_type -> user.v1.RegisterDeviceResponse
	58, // 93: user.v1.UserService.ListDevices:output_type -> user.v1.ListDevicesResponse
	60, // 94: user.v1.UserService.UpdateDevice:output_type -> user.v1.UpdateDeviceResponse
	62, // 95: user.v1.UserService.DeactivateDevice:output_type -> user.v1.DeactivateDeviceResponse
	64, // 96: user.v1.UserService.HealthCheck:output_type -> user.v1.HealthCheckResponse
