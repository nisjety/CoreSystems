...
const (
	TokenValidationService_ValidateToken_FullMethodName = "/dataplane.auth.v1.TokenValidationService/ValidateToken"
)
...
//
// TokenValidationService — lightweight RPC for Data Plane services
// to validate Bearer tokens against auth-core.
...
func RegisterTokenValidationServiceServer(s grpc.ServiceRegistrar, srv TokenValidationServiceServer) {
	// If the following call panics, it indicates UnimplementedTokenValidationServiceServer was
...
var TokenValidationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dataplane.auth.v1.TokenValidationService",
	...
	Metadata: "dataplane/auth/v1/token_validation.proto",
}
