...
seed_auth_service() {
  ...
  run_psql controlplane-postgres coresystem auth_service <<'SQL'
BEGIN;
...
seed_org_core() {
  ...
  run_psql controlplane-postgres coresystem org_core <<'SQL'
BEGIN;
...
seed_user_service() {
  ...
  run_psql controlplane-postgres coresystem user_service <<'SQL'
BEGIN;
...
seed_billing_service() {
  ...
  run_psql controlplane-postgres coresystem billing_service <<'SQL'
BEGIN;
...
seed_controlplane_events() {
  ...
  run_psql controlplane-postgres coresystem controlplane <<'SQL'
BEGIN;
